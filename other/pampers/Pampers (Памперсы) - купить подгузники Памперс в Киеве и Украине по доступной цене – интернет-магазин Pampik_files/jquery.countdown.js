    ...
    $.fn.countdown = function(prop){
        ...
        function updateDuo(minor,major,value){
            ...
            if(major - minor == 2) {
                ...
                switchDigit(positions.eq(1-1),Math.floor(value/10)%10);
                switchDigit(positions.eq(2-1),value%10);
            }
            else {
                switchDigit(positions.eq(minor-1),Math.floor(value/10)%10);
                switchDigit(positions.eq(major-1),value%10);
            }
        }
